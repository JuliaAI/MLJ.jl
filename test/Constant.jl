...
fitresult, cache, report =
    @notest_logs (:info, r"Fitted a constant probability distribution") MLJ.fit(model, 1, X, y)
...
fitresult, cache, report = @notest_logs (:info, r"probabilities") MLJ.fit(model, 1, X, y)
